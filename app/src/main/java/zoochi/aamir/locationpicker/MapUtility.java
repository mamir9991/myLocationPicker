...
public class MapUtility {
    ...
    public static void showProgress(final Context context) {
        try {
            if (!((Activity) context).isFinishing())   //Check to see whether this activity is in the process of finishingCheck to see whether this activity is in the process of finishing
            {
